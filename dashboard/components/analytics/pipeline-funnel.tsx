      ...
      {stages.map((stage) => (
        <div key={stage.stage} className="flex items-center gap-3">
          ...
          <div className="flex-1 h-8 relative">
            <div className="h-full rounded-button transition-all duration-300" style={{ width: `${(stage.count / max) * 100}%`, backgroundColor: getStatusColor(stage.stage), minWidth: stage.count > 0 ? "2rem" : "0" }} />
          </div>
